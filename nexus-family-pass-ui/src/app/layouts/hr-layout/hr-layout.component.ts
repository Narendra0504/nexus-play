...
@Component({
  ...
  template: `
    <div class="layout-container">
        ...
        <div class="sidebar-header">
          <div class="logo" *ngIf="!sidebarCollapsed()">
            ...
            <div class="logo-text">
              ...
              <span class="logo-subtitle">HR Portal</span>
            </div>
          </div>
        ...
        <header class="header">
          <div class="header-left">
            ...
            <div class="page-info hide-mobile">
              ...
              <p class="page-subtitle">Manage employee benefits program</p>
            </div>
          </div>
            ...
            <mat-menu #userMenu="matMenu" class="user-dropdown">
              <div class="menu-header">
                ...
                <div class="menu-user-info">
                  ...
                  <span class="menu-user-role">HR Administrator</span>
                </div>
              </div>
      ...
      <aside class="mobile-sidebar" [class.open]="mobileSidebarOpen()">
        <div class="sidebar-header">
          <div class="logo">
            <div class="logo-icon"><mat-icon>business</mat-icon></div>
            <div class="logo-text">
              <span class="logo-title">Nexus</span>
              <span class="logo-subtitle">HR Portal</span>
            </div>
  ...
  styles: [`
    ...
    .sidebar {
      width: 280px;
      background: linear-gradient(180deg, #0f766e 0%, #0d9488 50%, #14b8a6 100%);
      display: flex;
    ...
    .collapse-toggle {
      ...
      mat-icon { font-size: 18px; width: 18px; height: 18px; color: #0d9488; }
    ...
    .notification-btn {
      ...
      &:hover { background: rgba(20, 184, 166, 0.1); mat-icon { color: #0d9488; } }
    }
...
export class HrLayoutComponent implements OnInit {
  ...
  activeEmployees = signal(156);
  creditsUsed = signal(1240);
  ...
  navItems: NavItem[] = [
    ...
    { icon: 'assessment', label: 'Reports', route: '/hr/reports' },
    { icon: 'credit_card', label: 'Subscription', route: '/hr/subscription' },
    { icon: 'settings', label: 'Settings', route: '/hr/settings' }
  ];

  userName = computed(() => this.authService.userFullName() || 'HR Admin');
  userInitials = computed(() => {
    const user = this.authService.currentUser();
    return user ? (user.firstName?.[0] || '') + (user.lastName?.[0] || '') : 'HR';
  });
